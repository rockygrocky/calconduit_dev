...
add_shortcode( 'posts', 'themekit_shortcode_posts' );

function themekit_shortcode_posts( $atts, $content = null ) {
	$shortcode_path = apply_filters( 'themekit/shortcode_path', '' );
	$shortcode_template = trailingslashit( $shortcode_path ) . 'posts.php';

	if ( is_file( $shortcode_template ) ) {
		ob_start();
	...
	$atts = shortcode_atts( apply_filters( 'themekit/shortcode/posts_atts', array(
		'class'        => '',
		'css'          => '',
