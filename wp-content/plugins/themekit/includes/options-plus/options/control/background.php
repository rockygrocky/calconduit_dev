			...
			<div class="options-control-inputs">
				...
				<div class="background-custom">
					<div class="options-control-media-picker background-image">
						<div class="options-control-title"><?php esc_html_e( 'Background Image', THEME_TEXTDOMAIN ) ?></div>
						<div class="options-control-inputs">
							<div class="upload-dropzone">
								<span class="upload-message">
									<?php esc_html_e( 'Drop a file here or', THEME_TEXTDOMAIN ) ?>
									<a href="#" class="browse-media"><?php esc_html_e( 'select a file', THEME_TEXTDOMAIN ) ?></a>
									<a href="#" class="upload"></a>
								</span>
								<span class="upload-preview"></span>
							</div>
							<a href="#" class="button remove"><?php esc_html_e( 'Remove', THEME_TEXTDOMAIN ) ?></a>
						</div>
					...
					<div class="options-control-radio-images background-repeat">
						<div class="options-control-title"><?php esc_html_e( 'Background Repeat', THEME_TEXTDOMAIN ) ?></div>
						<div class="options-control-inputs">
							<label class="background-no-repeat">
								...
								<span data-title="<?php echo esc_attr( 'No Repeat', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'No Repeat', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-repeat-x">
								...
								<span data-title="<?php echo esc_attr( 'Repeat X', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Repeat X', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-repeat-y">
								...
								<span data-title="<?php echo esc_attr( 'Repeat Y', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Repeat Y', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-repeat-all">
								...
								<span data-title="<?php echo esc_attr( 'Repeat All', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Repeat All', THEME_TEXTDOMAIN ) ?></span>
							</label>
						</div>
					</div>

					<div class="options-control-radio-images background-position">
						<div class="options-control-title"><?php esc_html_e( 'Background Position', THEME_TEXTDOMAIN ) ?></div>
						<div class="options-control-inputs">
							<label class="background-top-left">
								...
								<span data-title="<?php echo esc_attr( 'Top Left', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Top Left', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-top-center">
								...
								<span data-title="<?php echo esc_attr( 'Top Center', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Top Center', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-top-right">
								...
								<span data-title="<?php echo esc_attr( 'Top Right', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Top Right', THEME_TEXTDOMAIN ) ?></span>
							</label>
							...
							<label class="background-middle-left">
								...
								<span data-title="<?php echo esc_attr( 'Middle Left', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Middle Left', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-middle-center">
								...
								<span data-title="<?php echo esc_attr( 'Middle Center', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Middle Center', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-middle-right">
								...
								<span data-title="<?php echo esc_attr( 'Middle Right', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Middle Right', THEME_TEXTDOMAIN ) ?></span>
							</label>
							...
							<label class="background-bottom-left">
								...
								<span data-title="<?php echo esc_attr( 'Bottom Left', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Bottom Left', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-bottom-center">
								...
								<span data-title="<?php echo esc_attr( 'Bottom Center', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Bottom Center', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-bottom-right">
								...
								<span data-title="<?php echo esc_attr( 'Bottom Right', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Bottom Right', THEME_TEXTDOMAIN ) ?></span>
							</label>
						</div>
					</div>

					<div class="options-control-radio-images background-style">
						<div class="options-control-title"><?php esc_html_e( 'Background Style', THEME_TEXTDOMAIN ) ?></div>
						<div class="options-control-inputs">
							<label class="background-fixed">
								...
								<span data-title="<?php echo esc_attr( 'Fixed', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Fixed', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-scroll">
								...
								<span data-title="<?php echo esc_attr( 'Scroll', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Scroll', THEME_TEXTDOMAIN ) ?></span>
							</label>
							<label class="background-cover">
								...
								<span data-title="<?php echo esc_attr( 'Cover', THEME_TEXTDOMAIN ) ?>"><?php esc_html_e( 'Cover', THEME_TEXTDOMAIN ) ?></span>
							</label>
						</div>
					</div>
				</div>
