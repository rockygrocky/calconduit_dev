...
class MediaInput extends \OptionsPlus\Options\Control
{
	...
	public function render_content() {
		...
		$value = $this->value();
		?>
			<div class="options-control-inputs" data-library="<?php linethemes_esc_attr( $this->library ) ?>">
				<input type="text" name="op-options[<?php linethemes_esc_attr( $this->id ) ?>]" value="<?php linethemes_esc_attr( $value ) ?>" />
				<button type="button" class="button button-browse"><?php esc_html_e( 'Browse...', 'konstruct' ) ?></button>
			</div>
		<?php
	}
}
