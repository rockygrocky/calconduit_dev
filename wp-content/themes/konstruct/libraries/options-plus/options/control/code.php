	...
	public function render_content() {
		...
		?>
			<div class="options-control-inputs">
				<textarea name="op-options[<?php linethemes_esc_attr( $this->id ) ?>]" id="<?php linethemes_esc_attr( $name ) ?>" data-mode="<?php linethemes_esc_attr( $this->mode ) ?>"><?php linethemes_esc_html( $this->value() ) ?></textarea>
			</div>
		<?php
	}
}
