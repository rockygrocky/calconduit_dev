	...
	public function render_content() {
		...
		?>
			<div class="options-control-inputs">
				<input type="text" id="<?php linethemes_esc_attr( $name ) ?>" name="op-options[<?php linethemes_esc_attr( $this->id ) ?>]" value="<?php linethemes_esc_attr( $this->value() ); ?>" />
				<button type="button" class="options-control-preview" style="background-color: <?php linethemes_esc_attr( $this->value() ) ?>;"></button>
