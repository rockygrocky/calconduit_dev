...
class Container
{
	...
	public function render() {
		...
		?>
			...
			<div class="<?php linethemes_esc_attr( (string) $class ) ?>">
				<?php if ( $this->show_tabs ): ?>
					<ul>
						<?php foreach( $this->sections as $section ): ?>
						<li id="options-section-<?php linethemes_esc_attr( $section->id ) ?>-nav">
							<a href="#options-section-<?php linethemes_esc_attr( $section->id ) ?>"><?php linethemes_esc_html( $section->title ) ?></a>
						</li>
						<?php endforeach ?>
					</ul>
				<?php endif ?>
