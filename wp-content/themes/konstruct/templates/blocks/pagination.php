...
$links = paginate_links( array(
	...
	'prev_text' => __( '&larr; Previous', 'konstruct' ),
	'next_text' => __( 'Next &rarr;', 'konstruct' ),
) );
...
$next_link = get_next_posts_link( __( 'Next &rarr;', 'konstruct' ) );
$prev_link = get_previous_posts_link( __( '&larr; Previous', 'konstruct' ) );
$more_link = get_next_posts_link( __( 'Load More', 'konstruct' ) );
