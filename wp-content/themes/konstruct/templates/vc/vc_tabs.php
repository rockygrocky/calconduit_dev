...
if ( 'vc_tour' == $this->shortcode ) {
	$output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', 'konstruct' ) . '">' . __( 'Previous tab', 'konstruct' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', 'konstruct' ) . '">' . __( 'Next tab', 'konstruct' ) . '</a></span></div>';
}
