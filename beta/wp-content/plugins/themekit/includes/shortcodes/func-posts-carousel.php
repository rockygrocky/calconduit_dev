...
add_action( 'admin_init', 'themekit_shortcode_posts_params' );
add_shortcode( 'posts_carousel', 'themekit_shortcode_posts_carousel' );

function themekit_shortcode_posts_carousel( $atts, $content = '' ) {
	ob_start();

	if ( $template = locate_template( array( 'templates/shortcodes/posts-carousel.php' ) ) )
		include $template;
	else
		include __DIR__ . '/templates/posts-carousel.php';

	return ob_get_clean();
}

function themekit_shortcode_posts_params() {
	...
	vc_map( array(
		'name'          => __( 'LineThemes: Posts Carousel', 'themekit' ),
		'base'          => 'posts_carousel',
		...
		'params'        => array(
			...
			array(
				'type'        => 'textfield',
				'heading'     => __( 'Tags', 'themekit' ),
				'description' => __( 'If you want to narrow output, enter tag names here. Note: Only listed tags will be included.', 'themekit' ),
				'param_name'  => 'tags'
			),
			...
			array(
				'type'        => 'dropdown',
				'heading'     => __( 'Show Post Date?', 'themekit' ),
				'description' => __( 'Select "Yes" to display post date in the carousel', 'themekit' ),
			...
			array(
				'type'        => 'textfield',
				'heading'     => __( 'Date format', 'themekit' ),
				'description' => __( 'Enter custom date format that will be shown', 'themekit' ),
			...
			array(
				'type'        => 'dropdown',
				'heading'     => __( 'Show Post Excerpt?', 'themekit' ),
				'description' => __( 'Select "Yes" to display post excerpt in the carousel', 'themekit' ),
			...
			array(
				'type'        => 'dropdown',
				'heading'     => __( 'Auto Post Excerpt?', 'themekit' ),
				'description' => __( 'Select "Yes" to display automatic generate post excerpt', 'themekit' ),
			...
			array(
				'type'        => 'textfield',
				'heading'     => __( 'Post excerpt length', 'themekit' ),
				'description' => __( 'Enter the custom length of post excerpt that will be generated', 'themekit' ),
